...
| --- | --- |
| An idea, and no idea where to start | The head of the main flow, whether the build is small enough to skip the spec, and whether each commit needs human review |
