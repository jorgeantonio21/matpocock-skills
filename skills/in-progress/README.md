...
- **[idiomatic-rust](./idiomatic-rust/SKILL.md)**: Contextual Rust idioms and invariant design for libraries, services, inference workloads, and CLI tools. Companion references cover checked construction and compatibility, runtime choices, dependency selection, and lint checks. Reached by the `implementer` and `craft-reviewer` agents on Rust diffs.
