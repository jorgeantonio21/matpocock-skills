...
Present the plan as a numbered list — for each commit, its title and the one sentence a reviewer would use to describe it. Ask the user whether the granularity is right, whether the order holds, and whether any commit should be split or merged.
